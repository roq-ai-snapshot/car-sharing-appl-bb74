  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of transportation with Car Sharing Application, your gateway to convenient, sustainable, and efficient car sharing services."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of transportation with Car Sharing Application, your gateway to convenient, sustainable, and efficient car sharing services.`}
            </Text>
            <Box
